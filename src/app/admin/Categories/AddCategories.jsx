...
const AddCategories = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await fetch(
        `/api/category/${deleteConfirmation.id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const uploadImageToExternalAPI = async (imageBase64) => {
    try {
      const response = await fetch(
        "https://couponri.divenclave.com/uploadImage.php",
        {
          method: "POST",
          headers: {
        ...
        Cell: ({ value }) => {
          return (
            <Image
              ...
              src={`https://couponri.divenclave.com/uploads/${value.trim()}`}
              alt="Category Image"
                  ...
                  placeholder="data:image/jpeg;base64,"
                      ...
                      src={
                        editingCategory.category_image instanceof File
                          ...
                          : `https://couponri.divenclave.com/uploads/${editingCategory.category_image}`
                      }
                      alt="Uploaded"
                      style={{
                        maxWidth: "100px",
