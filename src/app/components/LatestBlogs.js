        ...
        {blogs.slice(0, visibleBlogs).map((blog) => (
          ...
          >
            ...
            <div className="p-4 sm:p-6">
              <h3 onClick={() => handleReadMore(blog.web_slug)} className="text-lg font-semibold text-gray-900 hover:text-blue-800">{blog.title}</h3>

              <p className="relative text-gray-700 text-sm mt-2 overflow-hidden text-ellipsis"
                style={{
                  display: '-webkit-box',
              ...
              >
                {stripHtmlTags(blog.description, 100)} {/* Display stripped and truncated description */}
              </p>
              <button
                onClick={() => handleReadMore(blog.web_slug)}
